...
# Now next step is to create a GUI through which the user can interact with the above program.
# All we need is some basic knowledge of the Tkinter module of Python to make it:
